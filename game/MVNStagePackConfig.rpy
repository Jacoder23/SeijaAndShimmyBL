...
define pedestal_start_yoffset = 0
define pedestal_end_yoffset = 0.0
define pedestal_duration = 6.0
...
define mid_yoffset = 1.00
define back_yoffset = 1.0
define front_yoffset = 1.05
